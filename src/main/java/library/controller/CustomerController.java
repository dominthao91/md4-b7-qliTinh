...
import library.service.customer.ICustomerService;
...
public class CustomerController {
    ...
    public ModelAndView listCustomer(@RequestParam("search") Optional<String> search, Pageable page) {
        Page<Customer> customers;
        if (search.isPresent()) {
            customers = customerService.findAllByFirstNameContaining(search.get(), page);
        } else {
            customers = customerService.findAll(page);
        }
    ...
    public ModelAndView updateCustomer(@ModelAttribute("customer") Customer customer) {
        ...
        modelAndView.addObject("mes", "Customer updated successfully");
        return modelAndView;
    }
